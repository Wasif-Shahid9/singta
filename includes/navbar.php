...
<meta name="title" content="Singta Resources - Critical Minerals & Strategic Commodities">
<meta name="description" content="Singta Resources strategically controls the processing of elements vital to defense, global energy transition, and food security.">
<meta name="keywords" content="Singta Resources, Antimony, Tungsten, Aluminum, Potash, Phosphate, Critical Minerals, Refining, Supply Chain">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="author" content="Singta Resources">

<meta property="og:type" content="website">
<meta property="og:url" content="https://www.singta.com/"> <meta property="og:title" content="Singta Resources - Critical Minerals Infrastructure">
<meta property="og:description" content="Strategically securing global supply chains for defense and energy through domestic refining.">
<meta property="og:image" content="assets/images/logo/logo.webp"> <meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="https://www.singta.com/">
<meta property="twitter:title" content="Singta Resources - Critical Minerals Infrastructure">
<meta property="twitter:description" content="Strategically securing global supply chains for defense and energy through domestic refining.">
<meta property="twitter:image" content="assets/images/logo/logo.webp">
...
<body class="rs-smoother-yes rtl">
    ...
    <div id="pre-load">
        <div id="loader" class="loader">
            <div class="loader-container has-theme-red">
                <div class="loader-icon"><img src="assets/images/logo/logo.webp" alt=""></div>
            </div>
        </div>
    </div>
    ...
    <header>
        <div class="rs-header-area rs-header-two header-transparent has-theme-red has-border rs-sticky-header"
            id="rs-sticky-header">
            <div class="container-fluid">
                <div class="rs-header-inner">
                    <div class="rs-header-left">
                        <div class="rs-header-logo">
                            <a href="index.php"><img src="assets/images/logo/logo.webp" alt="logo"></a>
                    ...
                    <div class="rs-header-menu">
                        <nav id="mobile-menu" class="main-menu">
                            <ul class="multipage-menu">
                                ...
                                <li>
                                    <a href="about.php" <?php echo ($current_page == 'about.php') ? 'class="active"' : ''; ?>>About</a>
                                </li>
                                <li>
                    ...
                    <div class="rs-header-right">
                        <!-- call start -->
                        <a class="rs-btn has-theme-red has-icon ms-3 d-md-block d-none" href="contact.php">Investor Inquiries</a>
        ...
        <div class="rs-header-area rs-header-two header-transparent has-theme-red has-border">
            <div class="container-fluid">
                <div class="rs-header-inner">
                    <div class="rs-header-left">
                        <div class="rs-header-logo">
                    ...
                    <div class="rs-header-right">
                        ...
                        <a class="rs-btn has-theme-red has-icon ms-3 d-md-block d-none" href="contact.php">Investor Inquiries
            ...
            <div class="offcanvas-wrapper">
                <div class="offcanvas-content">
                    ...
                    <div class="offcanvas-about mb-30 d-none d-sm-block">
                        <p>Singta Resources strategically controls the processing of elements vital to defense, global
                            energy transition, and food security.</p>
                    </div>
                        ...
                        <ul>
                            <li class="d-flex align-items-center gap-15">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="#">200 West St.<br>
                                        New York, NY 10282, USA</a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center gap-15">
                                <div class="offcanvas-contact-icon">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="tel:+971555961659">+97 155 596 1659</a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center gap-15">
                                <div class="offcanvas-contact-icon">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="mailto:investors@singta.com">investors@singta.com</a>
                                </div>
                            </li>
                        </ul>
                    </div>
