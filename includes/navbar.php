...
<meta name="description"
    content="Singta Resources strategically controls the processing of elements vital to defense, global energy transition, and food security.">
<meta name="keywords"
    content="Singta Resources, Antimony, Tungsten, Aluminum, Potash, Phosphate, Critical Minerals, Refining, Supply Chain">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="author" content="Singta Resources">

<meta property="og:type" content="website">
<meta property="og:url" content="https://www.singta.com/">
<meta property="og:title" content="Singta Resources - Critical Minerals Infrastructure">
<meta property="og:description"
    content="Strategically securing global supply chains for defense and energy through domestic refining.">
            ...
            <div class="container-fluid">
                <div class="rs-header-inner">
                    ...
                    <div class="rs-header-right">
                        <!-- call start -->
                        <a class="rs-btn has-theme-red has-icon ms-3 d-md-block d-none" href="contact.php">Investor</a>
            ...
            <div class="container-fluid">
                <div class="rs-header-inner">
                    ...
                    <div class="rs-header-right">
                        ...
                        <a class="rs-btn has-theme-red has-icon ms-3 d-md-block d-none" href="contact.php">Investors
        ...
        <div class="offcanvas-area has-theme-red" data-lenis-prevent>
            <div class="offcanvas-wrapper">
                <div class="offcanvas-content">
                    ...
                    <div class='offcanvas-content-parent'>
                        <div class="offcanvas-about mb-30 d-none d-lg-block">
                            <p>Singta Resources strategically controls the processing of elements vital to defense,
                                global
                        ...
                        <div class="mobile-menu">
                            <div class="rs-offcanvas-menu mb-25">
                                ...
                                <h4 class="offcanvas-title-meta">Menu</h4>
                                    <ul class="multipage-menu offcanvas-menu">
                                        <?php
                                        $current_page = basename($_SERVER['PHP_SELF']);
                                        ?>
                                        <li>
